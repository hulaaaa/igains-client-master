...
export default function Favorite() {
  ...
  return (
    <View style={styles.container} onLayout={onLayoutRootView}>
      <SafeAreaView>
        <ScrollView
          refreshControl={<RefreshControl tintColor={'#E0FE10'} refreshing={refreshing} onRefresh={onRefresh} />} showsVerticalScrollIndicator={false}>
          
          <View style={styles.header}>
            <TouchableOpacity style={{padding: 5}} onPress={()=>navigation.navigate('Home')}>
              <Svg width={10} height={17} viewBox="0 0 10 17" fill="none">
                <Path d="M8.5 1L1 8.5L8.5 16" stroke="#fff" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round"/>
              </Svg>
            </TouchableOpacity>
            <View>
              <Text style={{ color: '#FFFFFF', fontSize: 21, fontFamily: 'Regular'}}>
                All favorite exercises
              </Text>
            </View>
            <View>
              <Svg width={10} height={17} viewBox="0 0 10 17" fill="none">
                <Path d="M8.5 1L1 8.5L8.5 16" stroke="none" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round"/>
              </Svg>
            </View>
          </View>
                                ...
                                justifyContent: 'center',
                                  ...
                                  <Svg xmlns="http://www.w3.org/2000/svg" fill="none">
                                      ...
                                      <Path
                                        stroke="#64C747"
                                        strokeWidth={0.6}
                                        d="m19.374 13.794.26.449.26-.449c.998-1.724 2.916-2.35 4.597-1.989 1.67.36 3.076 1.685 3.076 3.873 0 1.495-.89 3.052-2.391 4.821-1.115 1.316-2.534 2.71-4.102 4.254-.468.46-.95.934-1.44 1.423-.492-.49-.975-.964-1.444-1.426-1.567-1.542-2.984-2.936-4.098-4.25-1.5-1.77-2.392-3.326-2.392-4.822 0-2.181 1.404-3.513 3.071-3.877 1.678-.367 3.597.255 4.603 1.993Z"
                                      />
                                    </Svg>
                              </TouchableOpacity>
                            ):(
